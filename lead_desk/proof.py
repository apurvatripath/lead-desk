...
<main>
  ...
  <section class="grid">
    ...
    <article><div class="num">03 · ASSIGN</div><h2>Round-robin ownership</h2><div class="example"><strong>Assigned owner:</strong> alice@agency.com<br><strong>Route:</strong> hot_assigned<br><strong>CRM:</strong> HubSpot upsert queued</div><span class="pill">Durable assignment</span></article>
    <article><div class="num">04 · ALERT</div><h2>The team gets a short brief</h2><div class="example"><strong>HOT LEAD</strong><br>Hot Agency → alice@agency.com<br>Named budget, timeline, and clear buying language.</div><span class="pill">Webhook alert</span></article>
